  ...
  return (
    <div className='w-[80%] h-fit scroll-auto bg-orange-200 m-auto pb-[30px]'>
      <div className='w-full h-[70px] flex justify-between'>
        ...
        <div className='flex'>
          <Link href={'/'} className='m-[30px] cursor-pointer border border-zinc-950 h-fit pl-4 pr-4 relative hover:text-white hover:bg-black hover:shadow-md hover:shadow-gray-900'>Close</Link>
        </div>
      </div>
...
{error && <p>{ error.status }</p>}
        ...
        <div className='flex'>
          <Link href={'/'} className='mt-[40px] ml-[40px] cursor-pointer border border-zinc-950 h-fit pl-4 pr-4 relative hover:text-white hover:bg-black hover:shadow-md hover:shadow-gray-900'>Cancel</Link>
